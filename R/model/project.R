  ...
  # rownames(df_target)
    ...
    # for (i_time in 1:22) {
      # i_time=1
        ...
        # trial to fix Error in mu_S[mu_S < 0] <- x[x < 0], which comes out when calling getMort() and if a matrix component of available energy, feeding level or e is NA. However see comments below saying taht the problems is NA in n or initial_n....
        # avail_energy[1,]<-NA
