...
save.image(file = "/Users/nov017/Dropbox/Mizer-fleet_extension/data/FDData_opn3.RData") # was FDData_Nov2.RData or FDData_Nov.RData if using SEAmodel_opn2.RData as input
...
# OPTION 1, and 2 adn 4 and 5 and 6 (and 7?)

# last updates: 
# changed costs from g to opn and nothing changed in term of trnds but they make profits negative. 
# changed management rule to decrease effort in proportion to biomass of target (fixed a bug) and that change trends but better because more straighforward 
# need to reconsider the scale of ke so that changes in profits are reflected in changes in effort and as per units as discussed with Beth - values of ke ~ 100000 make changes in effort due to profit visible 
# add profits to the data and plot? 
