...
# attempt 1 - OK but much higher kappas, and abundances. thus much higher cacthes for some spp so that observed vs modelled catches is not looking great. better agreeement between observed adn modelled SSB adn worst agreement between observed adn modelled cacthes. As expected 

# attempt 2 - calibrate only with catches? or change Fmort. also squalus was left out of calibration but it might not be needed.  
